Shader "Unlit/handWritingtextShader"
{
	...
	Properties {
		...
		//If we do not do vertex coloring, we stick to previous version of the shader
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert(appdata_t IN)
			{
				...
				//Now _Color variable carries the actual color of a text, IN.color 
